...
const Card = (props) => {
    return (
        <div class="group">
        <div class="overflow-hidden transition duration-1000 group-hover:scale-105 flex rounded-3xl w-[40vmin] h-[56vmin] object-cover object-center group-hover:opacity-100 opacity-50">
          <div class="absolute top-[28vmin] rounded-b-3xl p-5 opacity-80 bg-gray-950 w-[40vmin] h-[28vmin] object-cover object-center">
            ...
            <div class="mt-5 text-md text-sky-100 text-center">
              {props.desc}
          ...
          <img class="image w-[40vmin] rounded-3xl h-[56vmin] object-cover object-center" src={props.image} draggable="false" />
